...
export { DateModel };
var NgxDatePickerOptions = (function () {
...
var NgxDatePickerComponent = (function () {
    ...
    NgxDatePickerComponent.prototype.generateCalendar = function () {
        ...
        var n = 1;
        var firstWeekDay = (this.options.firstWeekdaySunday) ?
        ...
        for (var i = n; i <= dateFns.getDate(dateFns.endOfMonth(date)); i += 1) {
